    ...
    public class FitnessInRangePawnConditionUIHandler : PawnSettingUIHandler<FitnessInRangePawnCondition>
    {
        ...
        protected override float Handle(Vector2 position, float width, FitnessInRangePawnCondition pawnCondition)
        {
            ...
            else
            {
                ...
                WorkManagerWindow.DoAddSettingButton<IPawnFitness, PawnFitnessDef>(menuButtonRect, "AWA.FunctionSelect".Translate(), (newSetting) => pawnCondition.Fitness = newSetting, true);
            ...
            Widgets.TextFieldNumeric(minRect, ref pawnCondition.Min, ref minBuffer);
            Widgets.TextFieldNumeric(maxRect, ref pawnCondition.Max, ref maxBuffer);
